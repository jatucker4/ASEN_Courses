function writeoutput(outputfile,inputfile,barforces,reacforces,...
    joints,connectivity,reacjoints,reacvecs,loadjoints,loadvecs)
...
for i=1:size(loadjoints,1)
    fprintf(fid,'%17d %12.2f %12.2f %12.2f\n',loadjoints(i),...
        loadvecs(i,1),loadvecs(i,2),loadvecs(i,3));
end
fprintf(fid,'\n');
...
for i=1:size(reacjoints,1)
    fprintf(fid,'%17d %12.2f %12.2f %12.2f %12.3f\n',reacjoints(i),...
        reacvecs(i,1),reacvecs(i,2),reacvecs(i,3),reacforces(i));
end
