function dydt = odefunc(t,y,c_forces, c_moments,flag,controlled,dev_v_ref,...
    dev_u_ref)
...
if flag
    ...
    if controlled
          ...
          c_moments(1) = (-0.001276*p-0.00232*phi);
          c_moments(2) = (-0.001584*q-0.00288*theta);
          c_moments(3) = c_moments(3)-r*0.004;          
    end
    ...
    if controlled
%         dydt(4) = (-0.001276*dev_p-0.00232*dev_phi)/(I_x);
%         dydt(5) = (-0.001584*dev_q-0.00288*dev_theta)/(I_y);
%         dydt(6) = -0.004*dev_r/I_z;
