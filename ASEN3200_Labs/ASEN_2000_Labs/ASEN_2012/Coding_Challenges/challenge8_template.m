%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CODE CHALLENGE 8 - Integrating Forward in Time with RK4
% 
% The purpose of this challenge is to solve for a car's velocity with
% respect to time. We will use fourth order Runge-Kutta to solve
...
%
% This code should also incorporate your Euler's method integration from
% the previous coding challenge, so you can compare side-by-side the
...
%
% CHALLENGE AUTHORS
% Torin Clark, Melinda Zavala, Justin Fay
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Housekeeping
clearvars
close all
