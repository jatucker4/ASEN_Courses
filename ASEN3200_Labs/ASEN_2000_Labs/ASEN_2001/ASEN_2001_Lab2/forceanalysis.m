function [barforces,reacforces]=forceanalysis(joints,connectivity,...
    reacjoints,reacvecs,loadjoints,loadvecs)
% function [barforces,reacforces]=forceanalysis(joints,connectivity,
% reacjoints,reacvecs,loadjoints,loadvecs)
%
...
[loadvecs, loadjoints] = weightcalc(loadjoints, loadvecs, joints,...
    numbars, connectivity, numjoints);

% Adds test loads to get a reasonable FOS

loadvecs(5,3) = loadvecs(5,3) - 1; % Applies 1 N down at joint 5
loadvecs(9,3) = loadvecs(9,3) - 1; % Applies 1 N down at joint 9
% build load vector
for i=1:numloads
